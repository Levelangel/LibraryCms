...
CREATE TABLE tb_Message_00000000(
...
CREATE TABLE tb_Message_00000001(
	[MessageID] INT IDENTITY(1,1)NOT NULL PRIMARY KEY,
	[From] INT NOT NULL,
	[Time] DATETIME NOT NULL,
	[Subject] TEXT NOT NULL,
...
CREATE TABLE tb_Message_00000002(
	[MessageID] INT IDENTITY(1,1)NOT NULL PRIMARY KEY,
	[From] INT NOT NULL,
	[Time] DATETIME NOT NULL,
	[Subject] TEXT NOT NULL,
...
GRANT INSERT,UPDATE,DELETE,SELECT ON tb_Message_00000000 TO admin
GRANT INSERT,UPDATE,DELETE,SELECT ON tb_Message_00000001 TO admin
GRANT INSERT,UPDATE,DELETE,SELECT ON tb_Message_00000002 TO admin
